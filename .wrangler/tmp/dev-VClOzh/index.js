...
// .wrangler/tmp/bundle-KP6jIn/checked-fetch.js
...
// .wrangler/tmp/bundle-KP6jIn/strip-cf-connecting-ip-header.js
...
adminRouter.options("*", () => new Response(null, { headers: corsHeaders }));
adminRouter.all("*", (request, env) => {
  const authResult = requireAdminAuthWithRateLimit(request, env);
  if (authResult) {
...
router.options("*", () => new Response(null, { headers: corsHeaders2 }));
...
// .wrangler/tmp/bundle-KP6jIn/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KP6jIn/middleware-loader.entry.ts
