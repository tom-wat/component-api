...
// .wrangler/tmp/bundle-6i6kX5/checked-fetch.js
...
// .wrangler/tmp/bundle-6i6kX5/strip-cf-connecting-ip-header.js
...
router.get("/api/health", (request, env) => {
  const corsHeaders3 = getCorsHeaders(env);
  return new Response(JSON.stringify({
    status: "ok",
...
// .wrangler/tmp/bundle-6i6kX5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-6i6kX5/middleware-loader.entry.ts
